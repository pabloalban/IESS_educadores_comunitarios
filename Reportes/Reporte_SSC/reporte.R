...
REP_anio_ini <- parametros$anio_ini
REP_anio <- parametros$anio
REP_anio_fin <- parametros$anio_fin
...
REP_tit <- 'Valuación Actuarial del Fondo del Seguro Social Campesino'
REP_nom_seg <- 'Seguro Social Campesino'
...
REP_file_latex_org <- c( paste( parametros$work_dir, 'Reportes//bibliografia_libros.bib', sep = '' ),
                         ...
                         paste( parametros$work_dir, 'Reportes/hombre.png', sep = '' ),
...
REP_file_latex_des <- c( paste( REP_rep_dir, 'bibliografia_libros.bib', sep = '' ), 
                         ...
                         paste( REP_rep_dir, 'graficos/hombre.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/mujer.png', sep = '' ))
