...
\begin{equation}
\hat{p}_{i,g,x}=\frac{\sum_{t=2016}^{2020} P_{i,t,g,x}}{\sum_{t=2016}^{2020} l_{t,g,x}^{2,ces}},
...
A continuación, se presentan las tablas de mortalidad para el año 2020 para la población de afiliados, 
