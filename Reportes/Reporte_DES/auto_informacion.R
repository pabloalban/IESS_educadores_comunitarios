...
load( paste0( parametros$RData_seg, 'IESS_DES_primas_', esc$nombre, '.RData' ) )
load( paste0( parametros$RData_seg, 'IESS_DES_balances_', esc$nombre, '.RData' ) )
#load( paste0( parametros$RData, 'IESS_IVM_analisis_ratios_', esc$nombre, '.RData' ) )
...
REP$tasa_aporte_esc_2<-format( 100 * esc$apo_act[1,2],
                               digits = 2, nsmall = 2, big.mark = '.', 
                               decimal.mark = ',', format = 'f' )
...
REP$pri_med_niv_esc_2 <- format( 100 * prima[ t == parametros$horizonte ]$pri_med_niv_apo,
                                 digits = 5, nsmall = 2, big.mark = '.', 
                                 decimal.mark = ',', format = 'f' )
...
REP$bal_sum_act_2 <- format( balance_anual[ t == parametros$horizonte ]$A_vap+esc$V0, 
                             digits = 2, nsmall = 2, big.mark = '.', 
                             decimal.mark = ',', format = 'f' )
...
REP$tasa_aporte_esc_3<-format( 100 * esc$apo_act[1,2],
                               digits = 2, nsmall = 2, big.mark = '.', 
                               decimal.mark = ',', format = 'f' )
...
REP$pri_med_niv_esc_3 <- format( 100 * prima[ t == parametros$horizonte ]$pri_med_niv_apo,
                                 digits = 4, nsmall = 2, big.mark = '.', 
                                 decimal.mark = ',', format = 'f' )

REP$tasa_porcentaje_gasto_esc_3<-format( 100 * esc$porcentaje_gasto,
                                         digits = 2, nsmall = 2, big.mark = '.', 
                                         decimal.mark = ',', format = 'f' )

REP$bal_sum_act_3 <- format( balance_anual[ t == parametros$horizonte ]$A_vap+esc$V0, 
                             digits = 2, nsmall = 2, big.mark = '.', 
                             decimal.mark = ',', format = 'f' )

REP$bal_sum_pas_3 <- format( balance_anual[ t == parametros$horizonte ]$B_vap+balance_anual[ t == parametros$horizonte ]$G_vap, 
                             digits = 2, nsmall = 2, big.mark = '.', 
                             decimal.mark = ',', format = 'f' )
# Prima de cesantía---------------------------------------------------------------------------------
REP$complemento<-format( 100 *(0.01- as.numeric(esc$apo_act[1,2])),
                         digits = 2, nsmall = 2, big.mark = '.', 
                         decimal.mark = ',', format = 'f' )
REP$pri_med_niv_cesantia<-format( 100 *(0.01- as.numeric(esc$apo_act[1,2]))+2,
                                  digits = 2, nsmall = 2, big.mark = '.', 
                                  decimal.mark = ',', format = 'f' )