...
La Dirección Actuarial, de Investigación y Estadística plantea 3 escenarios para realizar la valuación actuarial del Seguro de Desempleo, con un horizonte de proyección de 40 años. Los resultados de este estudio, se encuentran descritos en la tabla \ref{tab:iess_bal_act_vap_escenario_1}.
...
Todos los escenarios contemplados en este estudio presentan superávit (ver tabla \ref{tab:iess_resultados}), debido a su que prima tiene holgura, la cual recaudó USD 243.907.164,94 y solo se entregaron USD 25.101.120,79 por prestaciones en el año 2020; por lo cual, el único riesgo que asecha al Seguro de Desempleo es el operativo.

Gracias a sus reservas (USD \Sexpr{REP$cap_ini}) el \Sexpr{REP_seg} no corre el riesgo de presentar déficit en varias décadas; pero la falta ingresos financieros por rendimiento de las inversiones puede reducir el crecimiento de sus reservas, debido que a la fecha de emisión de este estudio no se han separado las inversiones del Seguro de Desempleo del de Cesantía; y, aún no han ingresado los rendimientos de estas inversiones en las cuentas de este seguro.
