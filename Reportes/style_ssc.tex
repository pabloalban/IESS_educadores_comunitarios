...
\usepackage{geometry}
\geometry{top=2cm, bottom= 3.5cm, left=3cm, right=2cm,footskip=1.7cm, includeheadfoot}
\usepackage[usegeometry]{typearea}


\newcommand{\regresargirar}{%
  \clearpage
  \KOMAoptions{paper=portrait,DIV=current}%switch to portrait
  \restoregeometry
  % \newgeometry{% geometry settings for landscap
   % top=2cm, bottom=3cm, left=3cm, right=2cm, includeheadfoot}%
   % \fancyhfoffset{0pt}%
 
}

\newcommand{\girarpagina}{%
  \clearpage
  \KOMAoptions{paper=landscape,DIV=current}%switch to landscape
  \newgeometry{% geometry settings for landscap
    top=0.5cm, bottom=1.0cm, left=2.5cm, right=2.5cm,headheight=1.5cm , includeheadfoot
  }%
  % \fancyhfoffset{0pt}%
...
% Incluir documentos en formato pdf
\usepackage{pdfpages}
\usepackage{lastpage}
...
%Para Códigos de Programación Script
\usepackage{listings}
...
\lstset{
    ...
    %moredelim=[is][\color[rgb]{0.9,0.9, 0.9}]{$}{_},
    %morecomment=[is]{$}{_},
    commentstyle= \@gobble,
    inputencoding=utf8,
    %numberstyle=\fontsize{6}{8}\selectfont\ttfamily \color[rgb]{0.4,0.4,0.4},
                % style used for the linenumbers
    %xrightmargin={\dimexpr 2em+3pt},
    %keywords = {library},
    %deletekeywords = {\$, <-},
...
\setfoot[\fontsize{8pt}{6pt}\bfseries{Página \thepage  \hspace {1pt} de \pageref*{LastPage}}][][]{}{}{\fontsize{8pt}{6pt}\bfseries{Página \thepage  \hspace {1pt} de \pageref*{LastPage}}}
...
% \newpagestyle{repchapstyle_acta}{
% \setfoot[\fontsize{8pt}{6pt}\bfseries{Página \thepage  \hspace {1pt} de \pageref*{LastPage}}][][]{}{}{\fontsize{8pt}{6pt}\bfseries{Página \thepage  \hspace {1pt} de \pageref*{LastPage}}}
% \sethead[][][]{}{}{}
% }
% \assignpagestyle{\chapter}{repchapstyle_acta}
