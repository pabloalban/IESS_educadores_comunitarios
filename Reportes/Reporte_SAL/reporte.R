...
REP_tit <- 'Valuación Actuarial del Fondo del Seguro General de 
            Salud Individual y Familiar'
REP_nom_seg <- 'Seguro de Salud'
...
REP_fec_val <- format( ymd( '2021-01-29' ), '%Y-%m-%d' )
...
REP_fec_corre <- format( parametros$fec_eje, '%Y-%m-%d' )

REP_fec_mes_corre <- format( parametros$fec_eje, '%m' )
REP_fec_anio_corre <- format( parametros$fec_eje, '%Y' )
REP_fec_dia_corre <- format( parametros$fec_eje, '%d' )
REP_fec_mes_corre_l <- if(REP_fec_mes_corre == '09'){
  'septiembre'
  } else if ( REP_fec_mes_corre == '06' ) { 
    'junio' 
  } else { 'julio' }
...
REP_file_latex_org <- c( paste( parametros$work_dir, 'Reportes/bibliografia_libros.bib', sep = '' ),
                         ...
                         paste( parametros$work_dir, 'Reportes/iess_piramide_afi_sgo_sal.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_piramide_afi_sgo_10_18_sal.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_piramide_acu_pen_sal.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_piramide_acu_pen_gen_sal.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_piramide_pen_ben_sal.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_pacientes_hosp_sal.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_mort_diag_sal.png', sep = '' ),
                         #paste( parametros$work_dir, 'Reportes/sumilla_actuario.png', sep = '' ),
                         paste( parametros$work_dir, 'Reportes/iess_pacientes_falle_sal.png', sep = '' ))
...
REP_file_latex_des <- c( paste( REP_rep_dir, 'bibliografia_libros.bib', sep = '' ), 
                         ...
                         paste( REP_rep_dir, 'graficos/iess_piramide_sgo_ecu_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_piramide_afi_sgo_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_piramide_afi_sgo_10_18_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_piramide_acu_pen_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_piramide_acu_pen_gen_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_piramide_pen_ben_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_pacientes_hosp_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_mort_diag_sal.png', sep = '' ),
                         paste( REP_rep_dir, 'graficos/iess_pacientes_falle_sal.png', sep = '' ))
