...
aux_ssc <- aux[ -c(4,5), ]
aux_ssc <- rbind( aux_ssc, data.frame( hipotesis ='Tasa Actuarial', tasas = 6.25))
aux_xtable_ssc <- xtable( aux_ssc, digits = c( 0,0,3) )
aux_xtable_ssc <- tildes_a_latex(aux_xtable_ssc)
