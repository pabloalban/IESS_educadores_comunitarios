...
# Carga de datos ---------------------------------------------------------------
load( file = paste0( "Y:/IESS_2020/RData/IVM/" ,'IESS_IVM_salidas_demograficos.RData'))
...
# Completo datos his´toricos tomados del BI para afiliados, para pensionistas se
# estima de 2016 a 2012 con tasa de decrecimiento
file <- paste0( 'Y:/IESS_2020/Data/IVM/'
                , 'DatosHistoricosDemografia.xlsx' )
...
iess_act_inac_f <- ggplot( aux[ tipo == 'Activ_female' | tipo == 'Inact_f' ], aes( x = Anio, y = Valor, fill = tipo ) ) +
...
# LECTURA Y TRATAMIENTO DE DATOS HISTORICOS
file <- paste0( 'Y:/IESS_2020/Data/IVM/'
                , 'DatosHistoricosDemografia.xlsx' )
...
# Graficando pensionistas de invalidez -------------------------------------------------------------
...
aux <- rbind( viu[, c('anio', 'total')], data.frame( anio = rev( viu$anio) ,  total = rep(0,length(rev( viu$anio)))))
...
aux <- rbind( orf[, c('anio', 'total')], data.frame( anio = rev( orf$anio) ,  total = rep(0,length(rev( orf$anio)))))
...
# Graficando nuevos pensionistas por tipo ----------------------------------------------------------
message( '\tGraficando nuevos pensionistas por tipo' )
...
# Graficando tasa de reparto -----------------------------------------------------------------------
message( '\tGraficando tasa de reparto' )


# Graficando pensionistas de invalidez -------------------------------------------------------------
message( '\tGraficando entradas el sistema' )
...
# # Graficando proporcion de afiliados activos e inactivos 3. 1 ---------------------------------
message( '\tGraficando proporcion de afiliados activos e inactivos ' ) 
...
# BARRAS ----------------------------------------------------
message( '\tGraficando  barras cotizantes activos por edad, sexo masculino' )
...
ggsave( plot = iess_cotizantes_activ_masculi_1,
        filename = paste0( parametros$resultado_graficos, 'iess_cotizantes_activ_masculi_1', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
ggsave( plot = iess_cotizantes_activ_unificado,
        filename = paste0( parametros$resultado_graficos, 'iess_cotizantes_activ_unificado', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# BARRAS HORIZONTALES --------------------------------
message( '\tGraficando  barras horizontales cotizantes activos por edad, sexo masculino' )
...
ggsave( plot = iess_cotizantes_mascul_2 ,
        filename = paste0( parametros$resultado_graficos, 'iess_cotizantes_mascul_2', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# PASTEL 3.2 M ------------------------------------------------------------------------------------
message( '\tGraficando pastel activos por edad, sexo masculino' )
...
iess_pastel_afi_cotiz_riesgo_mascul <- ggplot(aux1) + 
                                ...
                                geom_label(data=aux1[riesgos%notin%c('Cumple requisitos para vejez en 1 año o menos', 'Cumple requisitos para vejez en 5 años')],
                                        ...
                                        fill='white', color = "black") +
                                # geom_text( data=aux1[riesgos%notin%c('Cumple requisitos para vejez en 1 año o menos', 'Cumple requisitos para vejez en 5 años')],
                                #            aes(x = rlabel2*sin(mid_angle), y = rlabel2*cos(mid_angle), 
                                #               label = riesgos,
                                #               hjust = hjust, vjust = vjust), size=3, family = tipo_letra) +
                                # geom_text( data=aux1[riesgos%in%c( 'Cumple requisitos para vejez en 5 años')],
                                #            aes(x = rlabel2*sin(mid_angle), y = rlabel2*cos(mid_angle), 
                                #                label = riesgos,
                                #                hjust = 0.5, vjust = -0.2), size=3, family = tipo_letra) +
                                # geom_text( data=aux1[riesgos%in%c( 'Cumple requisitos para vejez en 1 año o menos')],
                                #            aes(x = rlabel2*sin(mid_angle), y = rlabel2*cos(mid_angle), 
                                #                label = riesgos,
                                #                hjust = 1.3, vjust = 2.5), size=3, family = tipo_letra) +
                                coord_fixed() + scale_fill_brewer(palette="Blues") +
  ...
  # geom_text_repel( data=aux1[riesgos%in%c( 'Cumple requisitos para vejez en 1 año o menos')],
  # aes(x = rlabel*sin(mid_angle)*0.8, y = rlabel*cos(mid_angle)*1.5,label=riesgos),
  #    size=3, max.overlaps = 10, box.padding = 0.1, 
  # nudge_x= rlabel2*sin(aux1[riesgos%in%c( 'Cumple requisitos para vejez en 1 año o menos')]$mid_angle), 
  # nudge_y= rlabel2*cos(aux1[riesgos%in%c( 'Cumple requisitos para vejez en 1 año o menos')]$mid_angle),
  # segment.curvature = -0.0) +
  # geom_text_repel( data=aux1[riesgos%in%c( 'Cumple requisitos para vejez en 5 años')],
  #                  aes(x = rlabel*sin(mid_angle)*1.2, y = rlabel*cos(mid_angle)*1.5,label=riesgos),
  #                  size=3, max.overlaps = 10, box.padding = 0.1, 
  #                  nudge_x= -1.2, 
  #                  nudge_y= 0.1, segment.curvature = -0.0
  #                  ) +
  # geom_text_repel( data=aux1[riesgos%notin%c( 'Cumple requisitos para vejez en 5 años', 'Cumple requisitos para vejez en 1 año o menos')],
  #                  aes(x = rlabel*sin(mid_angle), y = rlabel*cos(mid_angle)*1.5,label=riesgos),
  #                  size=3, box.padding = 0.5, 
  #                  nudge_x= rlabel2*sin(aux1[riesgos%notin%c( 'Cumple requisitos para vejez en 5 años', 'Cumple requisitos para vejez en 1 año o menos')]$mid_angle), 
  #                  nudge_y= rlabel2*cos(aux1[riesgos%notin%c( 'Cumple requisitos para vejez en 5 años', 'Cumple requisitos para vejez en 1 año o menos')]$mid_angle), 
  #                  segment.curvature = -0.0, segment.linetype = 'solid'
  # )


ggsave( plot = iess_pastel_afi_cotiz_riesgo_mascul ,
        filename = paste0( parametros$resultado_graficos, 'iess_pastel_afi_cotiz_riesgo_mascul', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# BURBUJAS -----------------------------------------------------------------------------------------
message( '\tGraficando  burbujas cotizantes activos por edad, sexo masculino' )
...
iess_afi_cotiz_riesgo_mascul <- ggplot(df2, aes(x =impos_años , y = -edad) ) +
  ...
  ggsave( plot = iess_afi_cotiz_riesgo_mascul,
        filename = paste0( parametros$resultado_graficos, 'iess_afi_cotiz_riesgo_mascul', parametros$graf_ext ),
...
# BARRAS ----------------------------------------------------
message( '\tGraficando barras cotizantes activos por edad, sexo femenino' )
...
ggsave( plot = iess_activ_cotiz_fem_1 ,
        filename = paste0( parametros$resultado_graficos, 'iess_activ_cotiz_fem_1', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# BARRAS HORIZONTALES --------------------------------
message( '\tGraficando barras horizontales cotizantes activos por edad, sexo femenino' )
...
ggsave( plot = iess_activ_cotiz_fem_2 ,
        filename = paste0( parametros$resultado_graficos, 'iess_activ_cotiz_fem_2', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# Unificado de activos por edad, sexo y numero
cotizantes_h <- copy( cotizantes )
cotizantes_m <- copy( activ_cotiz_fem )
unidad<-1e3
...
iess_activ_cotiz_sexo_unificado <- ggplot( cotizantes_t, aes( x = num, y = edad, fill = tipo) ) +
  ...
  theme_tufte()+
  # scale_y_discrete(breaks = y_brk, labels = y_lbl ) +
  # scale_y_discrete( breaks = brks_y, labels = lbls_y ) +
  scale_y_discrete(breaks = y_brk, labels = y_lbl) +
...
ggsave( plot = iess_activ_cotiz_sexo_unificado,
        filename = paste0( parametros$resultado_graficos, 'iess_activ_cotiz_sexo_unificado', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )



# PASTEL ------------------------------------------------------------------------------------
message( '\tGraficando pastel cotizantes activos por edad, sexo femenino' )
...
ggsave( plot = iess_pastel_afi_cotiz_riesgo_femen ,
        filename = paste0( parametros$resultado_graficos, 'iess_pastel_afi_cotiz_riesgo_femen', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# BURBUJAS ---------------------------------------------------
message( '\tGraficando burbujas cotizantes activos por edad, sexo femenino' )
...
ggsave( plot = iess_afi_cotiz_riesgo_femenin,
        filename = paste0( parametros$resultado_graficos, 'iess_afi_cotiz_riesgo_femenin', parametros$graf_ext ),
        width = 15, height = 18, units = graf_units, dpi = graf_dpi )

# MASCULINO
# # Distribución de cotizantes inactivos por edad, sexo masculino ---------------------
# BARRAS 
message( '\tGraficando barras cotizantes inactivos por edad, sexo masculino' )
...
# BARRAS HORIZONTALES -----------------------------
message( '\tGraficando barras horizontales cotizantes inactivos por edad, sexo masculino' )
...
iess_inac_cotiz_masc_2 <-ggplot(inac_cotiz_masc, aes(x=num, y=edad, fill= " " )) +
  ...
  theme_tufte()+
  scale_y_discrete(breaks = y_brk, labels = y_lbl) +
  #scale_x_discrete(breaks = brks_x, labels = lbls_x) +
  theme_bw() +
  plt_theme +
  scale_fill_manual(values = parametros$iess_blue)+
  theme(text = element_text( color = 'black' ),  
...
ggsave( plot = iess_inac_cotiz_masc_2,
        filename = paste0( parametros$resultado_graficos, 'iess_inac_cotiz_masc_2', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# PASTEL ----------------------------------------------------------
message( '\tGraficando pastel cotizantes inactivos por edad, sexo masculino' )
...
ggsave( plot = iess_pastel_afi_inac_cotiz_riesgo_mascul ,
        filename = paste0( parametros$resultado_graficos, 'iess_pastel_afi_inac_cotiz_riesgo_mascul', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# BURBUJAS ---------------------------------------------------
message( '\tGraficando burbujas cotizantes inactivos por edad, sexo masculino' )
...
ggsave( plot = iess_afi_cotiz_inac_riesgo_mascul,
        filename = paste0( parametros$resultado_graficos, 'iess_afi_cotiz_inac_riesgo_mascul', parametros$graf_ext ),
        width = 15, height = 18, units = graf_units, dpi = graf_dpi )

#FEMENINO -----------------------------------
# Distribución de cotizantes inactivos por edad, sexo femenino ---------------------
# BARRAS --------------------------------------------------
message( '\tGraficando barras cotizantes inactivos por edad, sexo femenino' )
...
ggsave( plot = iess_inac_cotiz_anios_unificado,
        filename = paste0( parametros$resultado_graficos, 'iess_inac_cotiz_anios_unificado', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

#BARRAS HORIZONTALES -------------------------------------------------
message( '\tGraficando barras horizontales cotizantes inactivos por edad, sexo femenino' )
...
ggsave( plot = iess_inac_cotiz_fem_2,
        filename = paste0( parametros$resultado_graficos, 'iess_inac_cotiz_fem_2', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

# Unificado ainativos por edad, sexo y numero ----------------------------------
cotizantes_h <- copy( inac_cotiz_masc )
cotizantes_m <- copy( inac_cotiz_fem )
unidad<-1e3
...
ggsave( plot = iess_inacti_sexo_unificado,
        filename = paste0( parametros$resultado_graficos, 'iess_inacti_sexo_unificado', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

#PASTEL ------------------------------------------------------------
message( '\tGraficando pastel cotizantes inactivos por edad, sexo femenino' )
...
ggsave( plot = iess_pastel_distri_inact_cotiz_riesgo_femen ,
        filename = paste0( parametros$resultado_graficos, 'iess_pastel_distri_inact_cotiz_riesgo_femen', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )

#BURBUJAS -------------------------------------------------------------
message( '\tGraficando burbujas cotizantes inactivos por edad, sexo femenino' )
...
ggsave( plot = iess_distri_inact_cotiz_riesgo_femen,
        filename = paste0( parametros$resultado_graficos, 'iess_distri_inact_cotiz_riesgo_femen', parametros$graf_ext ),
        width = 15, height = 18, units = graf_units, dpi = graf_dpi )
...
ggsave( plot = iess_tipo_pension_ambsex ,
        filename = paste0( parametros$resultado_graficos, 'iess_tipo_pension_ambsex', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
iess_tipo_pension_fem <- ggplot(aux1) + 
  ...
  geom_label( data=aux1[tipo_pens=='Viudez'],
              ...
              fill='white', color = "black") +
  geom_label( data=aux1[tipo_pens%notin%c('Orfandad','Viudez')],
              aes(x = rlabel*sin(mid_angle), y = rlabel*cos(mid_angle),
                  label = paste0(formatC(round( Por*100,2), decimal.mark = ','), '%'),
              ), family = tipo_letra, size=3, 
              fill='white', color = "black")+
...
ggsave( plot = iess_tipo_pension_fem ,
        filename = paste0( parametros$resultado_graficos, 'iess_tipo_pension_fem', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
ggsave( plot = iess_tipo_pension_masc ,
        filename = paste0( parametros$resultado_graficos, 'iess_tipo_pension_masc', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
#esc_cl <- paste(colorRampPalette(c('goldenrod4', "gray48"))(4), '50', sep='')
esc_cl <- c('firebrick4', 'gold', 'brown1', 'black')

iess_pension_sex_M <- ggplot(baseM, aes(x = edad5, y = valor, fill = variable) ) +
  geom_bar(stat = "identity", width = 1)+
  # scale_fill_manual(values = c(parametros$iess_blue, '#006cec', pie_2_color, pie_4_color))+
  ...
  scale_y_continuous( breaks = y_brk, labels = y_lbl, limits = y_lim) + 
  scale_x_continuous( breaks = x_brk, labels = x_lbl, limits = x_lim ) +
  labs(x = NULL, y = NULL, fill = NULL )+ ggtitle("Masculino")+theme_bw() +   plt_theme_legend +
...
iess_pension_sex_F <- ggplot(baseF, aes(x = edad5, y = valor, fill = variable) ) +
  geom_bar(stat = "identity", width = 1)+
  # scale_fill_manual(values = c(parametros$iess_green, '#00883e', pie_1_color, pie_3_color))+
  scale_fill_manual(values=c( 'Vejez' = esc_cl[1],
                              'Invalidez' = esc_cl[2],
                              'Viudez' = esc_cl[3],
                              'Orfandad' = esc_cl[4]) ) +
  scale_y_continuous( breaks = y_brk, labels = y_lbl, limits = y_lim) + 
  scale_x_continuous( breaks = x_brk, labels = x_lbl, limits = x_lim ) +
  labs(x = NULL, y = NULL, fill = NULL )+ ggtitle("Femenino")+theme_bw() +   plt_theme_legend +
  theme( axis.text.x = element_text(angle = 0, hjust = 0.5 ) ) +
  theme(legend.position="bottom") +
  theme(legend.key.size = unit(0.5, 'cm')) +
  theme(legend.position = 'bottom', legend.direction = "horizontal",
...
iess_benef_pensi_sexo_ambsex <- ggplot(aux1) + 
  ...
  geom_label( data=aux1[tipo_pens=='Orfandad'],
              ...
              fill='white', color = "black") +
  geom_label( data=aux1[tipo_pens%notin%c('Orfandad')],
              aes(x = rlabel*sin(mid_angle), y = rlabel*cos(mid_angle),
                  label = paste0(formatC(round( Por*100,2), decimal.mark = ','), '%'),
              ), family = tipo_letra, size=3, 
              fill='white', color = "black")+
...
ggsave( plot = iess_benef_pensi_sexo_ambsex ,
        filename = paste0( parametros$resultado_graficos, 'iess_benef_pensi_sexo_ambsex', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
ggsave( plot = iess_benef_pensi_sexo_femen ,
        filename = paste0( parametros$resultado_graficos, 'iess_benef_pensi_sexo_femen', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
ggsave( plot = iess_benef_pensi_sexo_mascul,
        filename = paste0( parametros$resultado_graficos, 'iess_benef_pensi_sexo_mascul', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
iess_val_prom_benef_vej_inv_viu_orf <- marrangeGrob(list(iess_val_prom_benef_vejz,
                                                    iess_val_prom_benef_inv,
                                                    iess_val_prom_benef_viud,
                                                    iess_val_prom_benef_orfan),  nrow = 2, ncol = 2, top = " ")

#iess_val_prom_benef_vej_inv_viu_orf

ggsave( plot = iess_val_prom_benef_vej_inv_viu_orf ,
        filename = paste0( parametros$resultado_graficos, 'iess_val_prom_benef_vej_inv_viu_orf', parametros$graf_ext ),
...
iess_benef_prom_sex_M <- ggplot()+
  geom_bar(data=aux3M , aes(x = variable, y = valor1, fill = "Beneficios promedio"), stat = "identity", width = 0.3)+
  ...
  scale_y_continuous(n.breaks = 10) +  theme_bw() +   plt_theme_legend +
  labs( x = NULL, y = NULL ) +
  ggtitle("Masculino")+
...
iess_benef_prom_sex_F <- ggplot()+
  geom_bar(data=aux3F , aes(x = variable, y = valor1, fill = "Beneficios promedio"), stat = "identity", width = 0.3)+
  geom_line(data = SBUM_F, aes(x = variable, y = valor1, group = 1,
                               linetype = 'SBUM'),
            inherit.aes = FALSE,
            size=0.5) +
...
iess_benef_prom_sex <- marrangeGrob(list(iess_benef_prom_sex_F, iess_benef_prom_sex_M),  nrow = 2, ncol = 1, top = " ")
