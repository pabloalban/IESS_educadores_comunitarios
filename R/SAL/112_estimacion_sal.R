...
load( paste0( parametros$RData_seg, 'IESS_SAL_afiliados_filtrado.RData' ) )
load( paste0( parametros$RData_seg, 'IESS_SAL_pensionistas_filtrado.RData' ) )
load( paste0( parametros$RData_seg, 'IESS_SAL_hijos_filtrado.RData' ) )
