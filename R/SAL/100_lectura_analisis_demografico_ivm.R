...
# Poblacion hijos SGO --------------------------------------------------
message( '\tLeyendo poblacion hijos SGO' )
col_nom <- c( 'anio', 'total', 'creci', 'hijos_h', 'creci_h', 'hijos_m', 'creci_m' )
col_tip <- c( 'text', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric' )

pob_hijos_18 <- read_excel( file,
                        sheet="Hijos_sgo_2020",
                        col_names = TRUE,
                        guess_max = 24000
                        )

pob_hijos_18 <- as.data.table( pob_hijos_18 )
setnames( pob_hijos_18, col_nom )

# Poblacion hijos por edad y sexo SGO ------------------------------------------
message( '\tLeyendo poblacion hijos SGO' )
col_nom <- c( 'edad', 'hijos_h', 'hijos_m' )
col_tip <- c( 'text', 'numeric', 'numeric' )

pob_hijos_18_edad <- read_excel( file,
                            sheet="Hijos_sgo_edad",
                            col_names = TRUE,
                            guess_max = 24000
)

pob_hijos_18_edad <- as.data.table( pob_hijos_18_edad )
setnames( pob_hijos_18_edad, col_nom )
...
lista <- c('pob_afi_ini', 'pob_afi_edad_sexo_ini','masa_salarial_ini','masa_sal_monto','afi_tiempo_aportacion','afi_tiempo_aportacion_h', 'afi_tiempo_aportacion_m',
           ...
           'pob_hijos_18', 'pob_hijos_18_edad' )
