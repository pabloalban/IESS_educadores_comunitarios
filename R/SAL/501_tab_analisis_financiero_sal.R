...
message( '\tLectura 5.13 Egresos Prestacionales y Gastos de Administración - Generando Tabla')
load(file = paste0(parametros$RData_seg,'IESS_o5_13_T3_EgresosPrestacionales.RData')) # carga el Rdata
#------------------------------------------------------------------ Tabla
...
message( '\tLectura 5.13 Egresos Prestacionales y Gastos de Administración - Generando Tabla')
load(file = paste0(parametros$RData_seg,'IESS_o5_13_T4_EgresosPrestacionales.RData')) # carga el Rdata
#------------------------------------------------------------------ Tabla
...
load(file = paste0(parametros$RData_seg,'IESS_o5_14_IngresosAportesVSEgresos.RData')) # carga el Rdata
#------------------------------------------------------------------ Tabla
...
load(file = paste0(parametros$RData_seg,'IESS_o5_15_ComparacionIngresosVSGast.RData')) # carga el Rdata
#------------------------------------------------------------------ Tabla
...
load(file = paste0(parametros$RData_seg,'IESS_o5_16_AnalisisReservasDisponibl.RData')) # carga el Rdata
#------------------------------------------------------------------ Tabla
