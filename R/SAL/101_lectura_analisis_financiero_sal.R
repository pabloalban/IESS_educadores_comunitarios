...
col_nom <- c( 'DESCRIPCIÓN DE LAS CUENTAS', 'A1', 'A2', 'A3','A4','A5','A6','A7','A8','A9','A10')
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric',
               'numeric', 'numeric')
...
# 
 ...
 col_nom <- c( 'DESCRIPCIÓN DE LAS CUENTAS', 'A1', 'A2', 'A3','A4','A5','A6','A7','A8','A9','A10','A11','A12')
...
# 
 ...
 col_tip <- c( 'character', 'numeric', 'numeric', 'numeric')
 file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
 ctas_x_cobrar<-read_excel(file,sheet="cuentas_cobrar",col_names=TRUE,guess_max = 24000)
...
# col_nom <- c( 'tipo_pasivo','descripcion_cuentas', 'tipo','2010', '2011', '2012', '2013','2014','2015','2016','2017','2018','2019','2020' )
col_nom <- c( 'descripcion_cuentas', 'tipo','2010', '2011', '2012', '2013','2014','2015','2016','2017','2018','2019','2020' )

col_tip <- c( 'character', 'character', 'character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric','numeric','numeric','numeric')

file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )

Comp_pasivo<-read_excel(file,sheet="Comp_pasivo_V2"
                        ,col_names=TRUE,guess_max = 24000)
...
# col_nom <- c('tipo_pasivo' ,'descripcion_cuentas','A1', 'A2', 'A3','A4','A5','A6','A7','A8','A9','A10')
col_nom <- c( 'descripcion_cuentas','A1', 'A2', 'A3','A4','A5','A6','A7','A8','A9','A10')
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Anali_Horiz_Pasivo <- read_excel( file, sheet = "Anali_Horiz_Pasivo_V2"
                                  , col_names = TRUE
                                  , guess_max = 24000 )
...
col_nom <- c( 'descripcion_cuenta','tipo', '2010', '2011', '2012', '2013','2014','2015','2016','2017','2018','2019','2020' )
col_tip <- c( 'character','character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Com_Patrimonio<-read_excel(file,sheet="Com_Patrimonio",col_names=TRUE,guess_max = 24000)
...
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Anali_horiz_Patr<-read_excel(file,sheet="Anali_horiz_Patr",col_names=TRUE,guess_max = 24000)
...
col_tip <- c('character','numeric','numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
ingresos<-read_excel(file,sheet="ingresos",col_names=TRUE,guess_max = 24000)
aux<-ingresos[1:11,]
ingresos <- as.data.table(aux)
...
col_tip <- c( 'character','character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Comp_Ingresos..<-read_excel(file,sheet="Comp_Ingresos..",col_names=TRUE,guess_max = 24000)
...
#  
# col_nom <- c( 'DESCRIPCIÓN DE LAS CUENTAS', 'A1', 'A2', 'A3','A4','A5','A6','A7','A8','A9','A10','A11')
# col_tip <- c( 'character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric','numeric')
# file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
# Anali_vert_Ingresos<-read_excel(file,sheet="Anali_vert_Ingresos",col_names=TRUE,guess_max = 24000)
...
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Egresos<-read_excel(file,sheet="Egresos",col_names=TRUE,guess_max = 24000)
...
# # COMPONENTES DE LOS GASTOS
 ...
 col_tip <- c( 'character', 'character','numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Comp_Egresos<-read_excel(file,sheet="Comp_Egresos",col_names=TRUE,guess_max = 24000)
...
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Anali_horiz_Egresos<-read_excel(file,sheet="Anali_horiz_Egresos",col_names=TRUE,guess_max = 24000)
Anali_horiz_Egresos <- as.data.table( Anali_horiz_Egresos )
setnames( Anali_horiz_Egresos, col_nom )
 
#Gastos prestacioneles
message( '\tLeyendo Gastos Prestacionales del Fondo de Salud.' )
col_nom <- c( 'Anio', 'A1', 'A2', 'A3','A4','A5','A6','A7','A8','A9','A10')
col_tip <- c( 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric','numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Gast_Presta<-read_excel(file,sheet="Gast_Presta",col_names=TRUE,guess_max = 24000)
...
#Ing_vs_Gast
message( '\tLeyendo Ingresos vs Gastos del Fondo de Salud.' )
col_nom <- c( 'Anio', 'A1', 'A2', 'A3','A4')
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric', 'numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Ing_vs_Gas<-read_excel(file,sheet="Ing_vs_Gas",col_names=TRUE,guess_max = 24000)
Ing_vs_Gas <- as.data.table( Ing_vs_Gas )
setnames( Ing_vs_Gas, col_nom )


#Rel_Pat_Gas
message( '\tLeyendo Ingresos vs Gastos del Fondo de Salud.' )
col_nom <- c( 'Anio', 'A1', 'A2', 'A3')
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric', 'numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Rel_Pat_Gas<-read_excel(file,sheet="Rel_Pat_Gas",col_names=TRUE,guess_max = 24000)
Rel_Pat_Gas <- as.data.table( Rel_Pat_Gas)
setnames( Rel_Pat_Gas, col_nom )

#Aju_Bal_Gen

message( '\tLeyendo Aju_Bal_Gen del Fondo de Salud.' )
col_nom <- c( 'Anio', 'A1', 'A2', 'A3')
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Aju_Bal_Gen<-read_excel(file,sheet="Aju_Bal_Gen",col_names=TRUE,guess_max = 24000)
Aju_Bal_Gen <- as.data.table( Aju_Bal_Gen)
setnames( Aju_Bal_Gen, col_nom )


#Aju_del_Est

message( '\tLeyendo Aju_del_Est del Fondo de Salud.' )
col_nom <- c( 'Anio', 'A1', 'A2', 'A3')
col_tip <- c( 'character', 'numeric', 'numeric', 'numeric')
file <- paste0( parametros$Data_seg, 'IESS_SAL_lectura_finaciero.xlsx' )
Aju_del_Est<-read_excel(file,sheet="Aju_del_Est",col_names=TRUE,guess_max = 24000)
Aju_del_Est <- as.data.table( Aju_del_Est)
setnames( Aju_Bal_Gen, col_nom )
...
lista<- c('activo','ctas_x_cobrar','Pasivo','Patrimonio','ingresos','Egresos','Anali_horiz_act','Anali_vert_act','Comp_pasivo','Anali_Horiz_Pasivo','Com_Patrimonio','Anali_horiz_Patr',
          'Comp_Ingresos..','Anali_horz_Ingresos','Comp_Egresos','Anali_horiz_Egresos','Gast_Presta','Ing_vs_Gas','Rel_Pat_Gas','Aju_Bal_Gen','Aju_del_Est')
save( list = lista,
...
col_tip<-c("character","numeric","numeric","numeric") 
o5_13_T1_EgresosPrestacionales <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_13_T1_EgresosPrestacionales",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_13_T1_EgresosPrestacionales)

col_nom <- c("Anio","Egresos_Prestacionales","Incremento_Anual","Variacion_Anual")  # nombres para la columna
o5_13_T1_EgresosPrestacionales <- setnames(o5_13_T1_EgresosPrestacionales,col_nom)

lista <- c("o5_13_T1_EgresosPrestacionales")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_13_T1_EgresosPrestacionales.RData'))   # Guarda como R Data

# 5.13 Tabla2 Egresos Prestacionales y Gastos de Administración ==========. ----
col_tip<-c("character","numeric","numeric","numeric") 
o5_13_T2_EgresosPrestacionales <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_13_T2_EgresosPrestacionales",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_13_T2_EgresosPrestacionales)

col_nom <- c("Anio","Gastos_Administracion","Incremento_Anual","Variacion_Anual")  # nombres para la columna
o5_13_T2_EgresosPrestacionales <- setnames(o5_13_T2_EgresosPrestacionales,col_nom)

lista <- c("o5_13_T2_EgresosPrestacionales")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_13_T2_EgresosPrestacionales.RData'))   # Guarda como R Data

# 5.13 Tabla3 Egresos Prestacionales y Gastos de Administración ==========. ----
col_tip<-c("character","numeric","numeric","numeric") 
o5_13_T3_EgresosPrestacionales <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_13_T3_EgresosPrestacionales",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_13_T3_EgresosPrestacionales)

col_nom <- c("Anio","Egresos_Prestacionales","Gastos_Administracion","Otros_Gastos","Total_Egresos")  # nombres para la columna
o5_13_T3_EgresosPrestacionales <- setnames(o5_13_T3_EgresosPrestacionales,col_nom)

lista <- c("o5_13_T3_EgresosPrestacionales")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_13_T3_EgresosPrestacionales.RData'))   # Guarda como R Data

# 5.13 Tabla4 Egresos Prestacionales y Gastos de Administración ==========. ----
col_tip<-c("character","numeric","numeric","numeric","numeric") 
o5_13_T4_EgresosPrestacionales <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_13_T4_EgresosPrestacionales",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_13_T4_EgresosPrestacionales)

col_nom <- c("Anio","Egresos_Prestacionales","Gastos_Administracion","Otros_Gastos","Total_Egresos")  # nombres para la columna
o5_13_T4_EgresosPrestacionales <- setnames(o5_13_T4_EgresosPrestacionales,col_nom)

lista <- c("o5_13_T4_EgresosPrestacionales")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_13_T4_EgresosPrestacionales.RData'))   # Guarda como R Data

# 5.13 Tabla5 Egresos Prestacionales y Gastos de Administración ==========. ----
col_tip<-c("character","numeric","numeric","numeric","numeric") 
o5_13_T5_EgresosPrestacionales <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_13_T5_EgresosPrestacionales",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_13_T5_EgresosPrestacionales)

col_nom <- c("Anio","Egresos_Prestacionales","Gastos_Administracion","Otros_Gastos","Total_Egresos")  # nombres para la columna
o5_13_T5_EgresosPrestacionales <- setnames(o5_13_T5_EgresosPrestacionales,col_nom)

lista <- c("o5_13_T5_EgresosPrestacionales")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_13_T5_EgresosPrestacionales.RData'))   # Guarda como R Data
...
o5_14_IngresosAportesVSEgresos <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_14_IngresosAportesVSEgresos",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_14_IngresosAportesVSEgresos)

col_nom <- c("Anio","Aport_Afili","Egr_Prestacion","60_Egr_Prestacion","Resultado",
             "Util_anual","valor_acumulacion","Acu_Reserva")  # nombres para la columna
o5_14_IngresosAportesVSEgresos <- setnames(o5_14_IngresosAportesVSEgresos,col_nom)

lista <- c("o5_14_IngresosAportesVSEgresos")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_14_IngresosAportesVSEgresos.RData'))   # Guarda como R Data
...
o5_15_ComparacionIngresosVSGast <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                           sheet="o5_15_ComparacionIngresosVSGast",
                                                           col_names = TRUE), #,col_types = "text"
                                                col_types = col_tip)

str(o5_15_ComparacionIngresosVSGast)

col_nom <- c("Anio","Aport_Afili","Gast_admi","Resultado","Util_Anual","Val_acumul")  # nombres para la columna
o5_15_ComparacionIngresosVSGast <- setnames(o5_15_ComparacionIngresosVSGast,col_nom)

lista <- c("o5_15_ComparacionIngresosVSGast")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_15_ComparacionIngresosVSGast.RData'))   # Guarda como R Data

# 5.16 Análisis de las Reservas Disponibles ==============================. ----
col_tip<-c("character","numeric","numeric","numeric") 
o5_16_AnalisisReservasDisponibl <- as.data.table(read_excel(paste0( parametros$Data_seg, "IESS_SAL_AnalisisInformacionFinanacieraContable.xlsx" ),
                                                            sheet="o5_16_AnalisisReservasDisponibl",
                                                            col_names = TRUE), #,col_types = "text"
                                                 col_types = col_tip)

str(o5_16_AnalisisReservasDisponibl)

col_nom <- c("Anio","Egr_presta","Patrimonio","Relacion")  # nombres para la columna
o5_16_AnalisisReservasDisponibl <- setnames(o5_16_AnalisisReservasDisponibl,col_nom)

lista <- c("o5_16_AnalisisReservasDisponibl")                                                      # Guarda el data table en la lista
save(list = lista, file = paste0(parametros$RData_seg,'IESS_o5_16_AnalisisReservasDisponibl.RData'))   # Guarda como R Data
