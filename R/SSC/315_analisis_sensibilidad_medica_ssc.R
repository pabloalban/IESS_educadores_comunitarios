...
message( '\tGenerando resultados del análisis de sensibilidad médica para el escenario 1' )

escenarios_part <- esc$part_tasas_infl 
resu <- NULL
val_root <- NULL
...
save( list=lista,
      file = paste0( parametros$RData_seg, 'IESS_SSC_analisis_sensibilidad_medica.RData' ) )
