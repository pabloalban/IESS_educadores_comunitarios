...
# 1) los salarios promedio de sus cotizantes a cesantía en el 2018;
...
# plot( aux_f$edad, aux_f$sal, type = 'l', col = parametros$iess_blue, ylim = c( 0, 1500 ) )
...
# plot( aux_m$edad, aux_m$sal, type = 'l', col = parametros$iess_blue, ylim = c( 0, 1500 ) )
