...
load( file = paste0( parametros$RData_seg, 'IESS_IVM_analisis_sensibilidad.RData' ) )
...
ggsave( plot = plt_bal_tasa_des, 
        filename = paste0( parametros$resultado_graficos, 'iess_plt_bal_tasa_des_ivm', parametros$graf_ext ),
