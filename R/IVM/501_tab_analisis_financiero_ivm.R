...
# Carga de datos -----------------------------------------------------------------------------------
load( file = paste0( parametros$RData_seg, 'IESS_IVM_analisis_financiero.RData' ) ) # Tablas generadas
...
# "Analisis vertical de Activos del Fondo de IVM"
...
# "Analisis horizontal de Pasivos del Fondo de IVM"
...
# Analisis vertical de Pasivos ---------------------------------------------------------------------------
# "Analisis vertical de Pasivos del Fondo de IVM"
...
# Analisis horizontal del Ingreso ---------------------------------------------------------------------------
# "Analisis horizontal del Ingreso del Fondo de IVM"
...
# Analisis horizontal del los Egresos ---------------------------------------------------------------------------
# "Analisis horizontal de los Egresos del Fondo de IVM"
...
# Analisis vertical de los Egresos ---------------------------------------------------------------------------
# "Analisis vertical de los egresos del Fondo de IVM"
