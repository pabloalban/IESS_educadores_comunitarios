...
ggsave( plot = plt_bal_act, 
        filename = paste0( parametros$resultado_graficos, 'iess_reserva_', escenario, parametros$graf_ext ),
...
ggsave( plot = plt_apo_ben_act, 
        filename = paste0( parametros$resultado_graficos, 'iess_apo_ben_bal_corriente_', escenario, parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
