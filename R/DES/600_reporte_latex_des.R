...
source( 'R/des/408_graf_tasas_decrementos_des.R', encoding = 'UTF-8', echo = FALSE )
source( 'R/des/409_graf_onu_life_survivors.R', encoding = 'UTF-8', echo = FALSE )
...
source( 'R/des/514_tab_decrementos_des.R', encoding = 'UTF-8', echo = FALSE )
