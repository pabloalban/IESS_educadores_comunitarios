...
inv_total_ces<- ggplot(data = df_bar, aes(x = Periodo, y = inversiones, fill = instrumento)) +
                ...
                geom_line(data = df_line, aes(x = Periodo, y = rendimiento_neto*hmts*scl*100-2000000000, group = 1,
...
inv_creditos_ces <- ggplot(data = df_bar, aes(x = Año, y = monto, fill = prestamos)) +
                    geom_bar(stat='identity',colour='black') +
                    theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
                    geom_line(data = df_line, aes(x = Año, y = rendimiento_promedio_ponderado*scl*hmts*100-52400000000, group = 1,
                    ...
                    scale_y_continuous(name = 'Inversiones (millones USD)', labels = y_lbl, breaks = y_brk,
                                       sec.axis = sec_axis(~./(scl*hmts*100)+0.08733333, name = 'Rendimiento Promedio',
...
iess_bonos_hist_inv<- ggplot(data = df_bar, aes(x = Periodo, y = valor_nominal, fill = Instrumento)) +
                      ...
                      geom_line(data = df_line,
                                aes(x = Periodo,
                                    y =rdto_prom_pond*hmts*scl*100-19520000000, group = 1, linetype = 'Rendimiento Promedio'),
                                inherit.aes = FALSE,
                                size=1) +
                      scale_linetype_manual(NULL, values = 1) +
                      scale_x_date(date_breaks = '1 year', date_labels = '%Y')+
                      scale_y_continuous(name = 'Saldo (millones USD)', labels = y_lbl, breaks = y_brk, limits = y_lim,
                                         sec.axis = sec_axis(~./(scl*hmts*100)+ 0.06506667, name = 'Rendimiento Promedio',
                                                             labels = ydual_lbl,
                                                             breaks = ydual_brk)) + 
                      scale_fill_manual(values = c(parametros$iess_green, parametros$iess_blue))+
                      theme_bw() +
...
iess_cert_cfn_hist_inv <- ggplot(data = df_bar, aes(x = Periodo, y = valor_nominal, fill = Instrumento)) +
                          ...
                          geom_line(data = df_line,
                                    aes(x = Periodo,
                                        y = rdto_prom_pond*hmts*scl*1000-780800000, group = 1, linetype = 'Rendimiento Promedio'),
                                    inherit.aes = FALSE,
                                    size=1) +
                          scale_linetype_manual(NULL, values = 1) +
                          scale_x_date(date_breaks = '1 year', date_labels = '%Y')+
                          scale_y_continuous(name = 'Saldo (millones USD)', labels = y_lbl, breaks = y_brk, limits = y_lim,
                          sec.axis = sec_axis(~./(scl*hmts*1000)+ 0.06006154, name = 'Rendimiento Promedio',
                                         labels = ydual_lbl,
                                         breaks = ydual_brk)) + 
                          scale_fill_manual(values = c(parametros$iess_green, parametros$iess_blue))+
                          theme_bw() +
...
iess_obligaciones_hist_inv <- ggplot(data = df_bar, aes(x = Periodo, y = valor_nominal, fill = Instrumento)) +
                              geom_bar(stat='identity',colour='black') +
                              theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
                              geom_line(data = df_line,
                                        aes(x = Periodo,
                                            y = rdto_prom_pond*hmts*scl*1000-298300000+5000000, group = 1, linetype = 'Rendimiento Promedio'),
                                        inherit.aes = FALSE,
                                        size=1) +
                              scale_linetype_manual(NULL, values = 1) +
                              scale_x_date(date_breaks = '1 year', date_labels = '%Y')+
                              scale_y_continuous(name = 'Saldo (millones USD)', labels = y_lbl, breaks = y_brk, limits = c(0,52000000),
                                                 sec.axis = sec_axis(~./(scl*hmts*1000)+0.07718421, name = 'Rendimiento Promedio',
                                                                     labels = ydual_lbl,
                                                                     breaks=ydual_brk)) + 
                              scale_fill_manual(values = c(parametros$iess_green, parametros$iess_blue))+
                              theme_bw() +
...
ggsave( plot = iess_obligaciones_hist_inv, 
        filename = paste0( parametros$resultado_graficos, 'iess_inv_obligaciones_des', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
iess_titularizaciones_hist_inv <- ggplot(data = df_bar, aes(x = Periodo, y = valor_nominal, fill = Instrumento)) +
                                  geom_bar(stat='identity',colour='black') +
                                  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
                                  geom_line(data = df_line,
                                            aes(x = Periodo,
                                                y = rdto_prom_pond*hmts*scl*100-3204000000+40000000, group = 1, linetype = 'Rendimiento Promedio'),
                                            inherit.aes = FALSE,
                                            size=1) +
                                  scale_linetype_manual(NULL, values = 1) +
                                  scale_x_date(date_breaks = '1 year', date_labels = '%Y')+
                                  scale_y_continuous(name = 'Saldo (millones USD)', labels = y_lbl, breaks = y_brk, limits = y_lim,
                                                     sec.axis = sec_axis(~./(scl*hmts*100)+0.0791, name = 'Rendimiento Promedio',
                                                                         labels = ydual_lbl,
                                                                         breaks = ydual_brk)) + 
                                  scale_fill_manual(values = c(parametros$iess_green, parametros$iess_blue))+
                                  theme_bw() +
...
ggsave( plot = iess_titularizaciones_hist_inv, 
        filename = paste0( parametros$resultado_graficos, 'iess_inv_titularizaciones_ces', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
iess_fidecomisos_hist_inv<- ggplot(data = df_bar, aes(x = Periodo, y = valor_nominal, fill = Instrumento)) +
  geom_bar(stat='identity',colour='black') +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_line(data = df_line,
            aes(x = Periodo,
                y = rdto_prom_pond*hmts*scl*100-510000000+30000000, group = 1, linetype = 'Rendimiento Promedio'),
            inherit.aes = FALSE,
            size=1) +
  scale_linetype_manual(NULL, values = 1) +
  scale_x_date(date_breaks = '1 year', date_labels = '%Y')+
  scale_y_continuous(name = 'Saldo (millones USD)', labels = y_lbl, breaks = y_brk,limits = y_lim,
                     sec.axis = sec_axis(~./(scl*hmts*100)+0.048, name = 'Rendimiento Promedio',
                                         labels = ydual_lbl,
                                         breaks = ydual_brk)) + 
  scale_fill_manual(values = c(parametros$iess_green, parametros$iess_blue))+
  theme_bw() +
...
ggsave( plot = iess_fidecomisos_hist_inv, 
        filename = paste0( parametros$resultado_graficos, 'iess_inv_fidecomisos_des', parametros$graf_ext ),
        width = graf_width, height = graf_height, units = graf_units, dpi = graf_dpi )
...
iess_rv_hist_inv <- ggplot(data = df_bar, aes(x = Periodo, y = valor_nominal, fill = Instrumento)) +
                    ...
                    geom_line(data = df_line,
                              aes(x = Periodo,
                                  y = rdto_prom_pond*hmts*scl*1000, group = 1, linetype = 'Rendimiento Promedio'),
                              inherit.aes = FALSE,
                              size=1) +
                    scale_linetype_manual(NULL, values = 1) +
                    scale_x_date(date_breaks = '1 year', date_labels = '%Y')+
