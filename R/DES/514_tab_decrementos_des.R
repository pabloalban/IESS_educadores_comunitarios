...
# Cargando datos -----------------------------------------------------------------------------------
load( file = paste0( parametros$RData_seg, 'IESS_tabla_decrementos.RData' ) )
load( file = paste0( parametros$RData_seg, 'IESS_tablas_biometricas_mortalidad_todos_estados.RData' ) )
