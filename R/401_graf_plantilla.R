...
plt_theme_legend_pie <- theme(text = element_text( color = 'black' ),  
                              panel.grid.major.x = element_line( colour = "white", size = graf_grid_major_size, linetype = 3 ),
                              panel.grid.major.y = element_line( colour = "white", size = graf_grid_major_size, linetype = 3 ),
                              panel.grid.minor.x = element_line( colour = "white", size = graf_grid_minor_size, linetype = 3 ),
                              panel.grid.minor.y = element_line( colour = "white", size = graf_grid_minor_size, linetype = 3 ),
